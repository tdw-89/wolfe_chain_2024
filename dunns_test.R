...
write.csv(as.data.frame(dup.dunn.test$test.result), "./data/expr_dunns_test.csv")
...
write.csv(as.data.frame(human.dunn.test$test.result), "./data/h3k9me3_dunns_test_humans.csv")
