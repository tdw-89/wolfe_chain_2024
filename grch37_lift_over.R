...
# Files
sens_data_file <- "../../dicty_data/mammals/primates/h_sapiens/NIHMS1819123-supplement-14-dosage-sensitivity-predictions.csv"
lift_over_chain_file <- "../../dicty_data/mammals/primates/h_sapiens/GRCh37_to_GRCh38_Ensembl.chain"
...
gencode_v19_gtf <- "../../dicty_data/mammals/primates/h_sapiens/gencode.v19.chr_patch_hapl_scaff.annotation.gtf"
...
# Save the overlap df
write.csv(overlap_df, "../../dicty_data/lift_over_data_full.csv")
...
write.csv(overlap_df_filtered, "../../dicty_data/lift_over_data_filtered.csv")
write.csv(mismatches, "../../dicty_data/lift_over_data_mismatches.csv")
